...
int main()
{
	//Create the window -- Lab 3: Note the window is smaller now so we can muck around with 'views'
	sf::RenderWindow window(sf::VideoMode({ 500, 500 }), "cmp105: Lab 3");
	window.setVerticalSyncEnabled(true);

	// Initialise input and manager objects (manager objects not yet covered)
	Input input;
